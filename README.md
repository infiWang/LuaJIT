...
**This is the release patch branch of LJRV, containing patchset based on LJRV dev branch commit [f6d3bdbc4b8b ("riscv(jit,interp): correct math.{min,max} behavior with NaN")](https://github.com/plctlab/LuaJIT/commit/f6d3bdbc4b8bf37407e3b79e1efdb86c5fa2ecdc), based off LuaJIT v2.1 rolling [f73e649a954b ("Merge branch 'master' into v2.1")](https://github.com/LuaJIT/LuaJIT/commit/f73e649a954b599fc184726c376476e7a5c439ca)**
