...
**This is the release patch branch of LJRV, containing patchset based on LJRV dev branch commit [d988658a5cea ("riscv(asm): fix usage of Zfa FLI")](https://github.com/plctlab/LuaJIT/commit/d988658a5cea5ce46e12749dba0ca3cd68a0ea8e), based off LuaJIT v2.1 rolling [a4f56a459a58 ("Merge branch 'master' into v2.1")](https://github.com/LuaJIT/LuaJIT/commit/a4f56a459a588ae768801074b46ba0adcfb49eb1)**
